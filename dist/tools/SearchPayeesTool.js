...
export const description = "Searches payees by name in a YNAB budget. Syncs payees first to ensure fresh data, then searches locally. Search is case-insensitive partial match. Use this to find payees matching a search term.";
