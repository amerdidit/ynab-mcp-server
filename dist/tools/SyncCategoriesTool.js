...
export const description = "Syncs categories from YNAB to local cache. Returns category count and sync statistics. Use search_categories to find specific categories by name, or get_category to get a single category by ID.";
