...
function ensureCacheLoaded() {
    if (cacheLoaded)
        return;
    const cached = readGlobalCache(CACHE_FILENAME);
    if (cached) {
...
function saveToCache() {
    writeGlobalCache(CACHE_FILENAME, {
        requestsUsed,
 ...
 */
export function updateFromHeader(headerValue) {
    ensureCacheLoaded();
 ...
 */
export function getRateLimitWarningLevel() {
